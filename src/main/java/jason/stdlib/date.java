...
/**
 * <p>
 * Internal action: <b><code>.date(YY,MM,DD)</code></b>.
 * 
 * <p>
...
public class date extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        ...
        return un.unifies(args[0], new NumberTermImpl(now.get(Calendar.YEAR))) && un.unifies(args[1], new NumberTermImpl(now.get(Calendar.MONTH) + 1))
