...
/**
 * <p>
 * Internal action: <b><code>.current_intention</code></b>.
 * 
 * <p>
 ...
 * intention has the following form:<br>
 * <br>
 * 
 * <code>intention(<i>id</i>,<i>stack of intended means</i>)</code><br>
 * <br>
 * 
 * where each intended means has the form:<br>
 * <br>
 * 
 * <code>im(<i>plan label</i>,<i>plan body term</i>, <i>unification function (a list of maps)</i>)</code><br>
 * <br>
 * 
 * For example:<br>
 * <br>
