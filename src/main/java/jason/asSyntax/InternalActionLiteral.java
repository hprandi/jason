...
public class InternalActionLiteral extends Structure implements LogicalFormula {
    ...
    private InternalAction ia = null; // reference to the object that implements the internal action, stored here to speed up the process of looking for the IA class inside the
                                        // agent
