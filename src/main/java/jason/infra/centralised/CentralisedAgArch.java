...
public class CentralisedAgArch extends AgArch implements Runnable {
	...
	private Sensor sensor = new SimpleSensor();
	private Actuator actuator = new SimpleActuator();
	...
	public Collection<Literal> perceive() {
		...
		this.logger.severe("percepts: " + percepts);
		return percepts;
	}
	...
	public void act(ActionExec action) {
		this.actuator.act(action.getActionTerm());
	}
